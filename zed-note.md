...
4. 本地交叉编译 remote_server 报错
    ...
    error: linking with `aarch64-linux-gnu-gcc` failed: exit status: 1
      ...
      解决办法：
      1. 修改 .cargo/config.toml，使用 "link-arg=-Bmold"， https://github.com/zed-industries/zed/pull/19910
      2. 安装 mold（可能非必须）：zj@a:~/go/src/github.com/zed-industries/zed$ brew install mold
